...
const Home = () => {
    ...
    return (
        <section className="bg-yellow-100 flex justify-center">
            <article className="flex flex-col gap-8 w-full items-center py-9">
                <nav className="w-full flex items-center justify-between px-3 lg:px-8">
                <h1 className="text-lg lg:text-2xl py-5  font-bold">Advanced Todo App</h1>
